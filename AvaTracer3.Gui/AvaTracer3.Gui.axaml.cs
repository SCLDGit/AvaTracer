...
using AvaTracer3.Gui.Models.BackingModels;
using AvaTracer3.Gui.Models.DataStructures.Logging;
using AvaTracer3.Gui.Models.Globals;
using AvaTracer3.Gui.Models.Utilities;
using AvaTracer3.Gui.ViewModels;
using AvaTracer3.Gui.Views;
...
{
    public class AvaTracer3GuiApp : Application
    {
        private readonly IHost m_appHost;

        public AvaTracer3GuiApp()
        {
